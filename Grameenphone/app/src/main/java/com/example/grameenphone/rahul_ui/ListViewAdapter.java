   ...
   // LayoutInflater inflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            ...
            holder.value= (TextView) itemView.findViewById(R.id.value);
        ...
        holder.accountNumber_String.setText(l.getAccountNumber_String());
        holder.billNumber_String.setText(l.getBillNumber_String());
        holder.company_String.setText(l.getCompany_String());
        holder.dueDate_String.setText(l.getDueDate_String());
        holder.checkBox.setChecked(l.isSelected());
        holder.checkBox.setTag(l);
        holder.accountNumber.setText(l.getAccountNumber());
        holder.billNumber.setText(l.getBillNumber());
        holder.company.setText(l.getCompany());
        holder.dueDate.setText(l.getDueDate());
        holder.value.setText(l.getValue());
        holder.inr.setText(l.getInr());
