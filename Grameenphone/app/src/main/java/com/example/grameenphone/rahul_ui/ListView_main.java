...
import com.example.grameenphone.payment.CancelAssociationActivity;
import com.example.grameenphone.payment.NewAssociationActivity;
 ...
 */
public class ListView_main extends ActionBarActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paySelectedBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                paySelectDialog = new AppCompatDialog(ListView_main.this);
                ...
                paySelectDialog.getWindow().setLayout(650, 400);
        ...
        otherPaymentBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ListView_main.this, PaymentActivity.class));
            }
        });

        toolbarImageIcon01.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ListView_main.this, NewAssociationActivity.class));
            }
        });
        toobarImageIcon02.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ListView_main.this, CancelAssociationActivity.class));
