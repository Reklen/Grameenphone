 ...
 */
public class InternetTabFragment extends BaseTabFragment {
    ...
    public static InternetTabFragment newInstance(Bundle b) {
        InternetTabFragment internetTabFragment = new InternetTabFragment();
