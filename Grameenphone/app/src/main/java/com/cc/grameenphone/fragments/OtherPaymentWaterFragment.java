 ...
 */
public class OtherPaymentWaterFragment extends BaseTabFragment implements Validator.ValidationListener {
    ...
    public static OtherPaymentWaterFragment newInstance(Bundle b) {
        OtherPaymentWaterFragment insuranceTabFragment = new OtherPaymentWaterFragment();
                ...
                public void success(final Response model, Response response) {
                    ...
                    try {
                        ...
                        if (commandJsonObject.has("TXNSTATUS")) {
                            ...
                            intent.putExtra("otherCategory","WATER");
