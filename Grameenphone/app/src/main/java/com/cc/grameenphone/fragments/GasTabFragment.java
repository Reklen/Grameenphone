 ...
 */
public class GasTabFragment extends BaseTabFragment {
    ...
    public static GasTabFragment newInstance(Bundle b) {
        GasTabFragment gasTabFragment = new GasTabFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_tab_gas, container, false);
