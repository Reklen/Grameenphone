 ...
 */
public class MultipleBillRequestBody {
    ...
    public MultipleBillRequestBody(int accountNumber, int billNumber, String company, String dueDate, boolean selected, int value) {
